...
from processjson import process_json  # Import the process_json function
...
parser.add_argument(
    '--process-messages',
    action='store_true',
    help='Process messages using the process_json function.'
)
...
if args['process_messages']:
    ...
    sys.exit(0)  # Exit after processing messages
...
# Methods: - GetHistoryRequest - SearchGlobalRequest
# iterate channels
