...
class Whatsapp_Explainer:
    ...
    """
    def __init__(self, mistral : mistral_classifier, output_parser, management_detoxi:ManagementDetoxigramers_Whatsapp):
...
class Telegram_Explainer:
    ...
    - explain: Actualiza la explicación de la conversación en detoxigramer si el estado no es 'NONE'. Genera una explicación de la toxicidad de una conversación, actualizando el estado del usuario.
    """
    def __init__(self, mistral : mistral_classifier, output_parser, management_detoxi:ManagementDetoxigramers_Telegram):
        self.mistral = mistral
        self.output_parser = output_parser
        self.management_detoxi = management_detoxi
        self.llm = mistral.chat
