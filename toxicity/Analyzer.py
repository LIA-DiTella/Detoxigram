...
from user_management.ManagementDetoxigramers import ManagementDetoxigramers_Telegram, ManagementDetoxigramers_Whatsapp
...
class WhatsApp_Analyzer:
    ...
    """
    def __init__(self, hatebert : hate_bert_classifier, mistral : mistral_classifier, management_detoxigramers):
